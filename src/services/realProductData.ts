...
export const realProducts: Product[] = [
    {
        ...
        specs: ['6.1-inch Super Retina XDR display', 'A16 Bionic chip with 5-core GPU', '48MP Main + 12MP Ultra Wide camera', 'USB-C Interface', 'All-day battery life (up to 20h video)']
    },
    {
        id: 's24-ultra',
        ...
        specs: ['6.8-inch QHD+ Dynamic AMOLED 2X', 'Snapdragon 8 Gen 3 for Galaxy', '200MP Quad Telephoto System', 'Integrated S Pen', 'Titanium Frame']
    },
    {
        id: 'macbook-m3',
        ...
        specs: ['M3 chip with 8-core CPU/8-core GPU', '13.6-inch Liquid Retina display', '8GB Unified Memory, 256GB SSD', 'Up to 18 hours battery life', '1080p FaceTime HD camera']
    },
    {
        id: 'sony-xm5',
        ...
        specs: ['Multiple noise sensor technology', 'Integrated Processor V1', '30-hour battery life (Quick Charge)', 'Precise Voice Pickup technology', 'Smart listening features']
    },
    {
        id: 'ipad-air',
        ...
        specs: ['11-inch Liquid Retina display', 'Apple M2 chip', '12MP Landscape Ultra Wide front camera', 'Apple Pencil Pro compatible', 'USB-C charging']
    },
    {
        id: 'dell-xps',
        ...
        specs: ['Intel Core Ultra 5-125H Processor', '13.4-inch FHD+ InfinityEdge display', '16GB LPDDR5x RAM, 512GB SSD', 'Intel Arc Graphics', 'Machined Aluminum Chassis']
    },
    {
        id: 'ps5-slim',
        ...
        specs: ['1TB Ultra-High Speed SSD', 'Integrated I/O with Ray Tracing', '4K-TV Gaming support', 'Haptic Feedback via DualSense', 'Slimmer design with Disc Drive']
    },
    {
        id: 'canon-r50',
        ...
        specs: ['24.2 MP APS-C CMOS sensor', 'DIGIC X Image Processor', '4K Uncropped 30p video', 'Dual Pixel CMOS AF II', 'Compact and lightweight design']
    },
    {
        id: 'amazfit-gtr4',
        ...
        specs: ['1.43" AMOLED display', 'Dual-band circular-polarized GPS', 'BioTracker 4.0 PPG Biometric Sensor', '14-day battery life', '150+ Sports Modes']
    },
    {
        id: 'bose-qc-ultra',
        ...
        specs: ['CustomTune technology', 'World-class noise cancellation', 'Spatial Audio (Immersive Audio)', '6-hour battery life (24h with case)', 'SimpleTouch controls']
    }
];
